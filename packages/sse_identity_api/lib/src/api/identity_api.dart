...
import 'dart:convert';
import 'package:sse_identity_api/src/deserialize.dart';
...
class IdentityApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AdminResetPasswordResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminResetPasswordResponse>> adminResetUserPassword({
    required String id,
    ...
    final _path = r'/users/{id}/reset-password'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    try {
      _bodyData = jsonEncode(adminResetPasswordRequest);
    ...
    AdminResetPasswordResponse? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<AdminResetPasswordResponse, AdminResetPasswordResponse>(
              rawData,
    ...
    return Response<AdminResetPasswordResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChangePasswordResponse>> changeMyPassword({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ChangePasswordResponse, ChangePasswordResponse>(
              rawData,
  ...
  Future<Response<User>> lockUser({
    ...
    final _path = r'/users/{id}/lock'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  Future<Response<OkResponse>> logout({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<OkResponse, OkResponse>(
              rawData,
              'OkResponse',
              growable: true,
            );
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponse>> refreshSession({
  ...
  /// Returns a [Future] containing a [Response] with a [OkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OkResponse>> resetPassword({
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> unlockUser({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{id}/unlock'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> updateMyProfile({
    required UpdateMyProfileRequest updateMyProfileRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(updateMyProfileRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
