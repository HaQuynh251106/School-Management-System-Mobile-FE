...
abstract class _$ForgotPasswordRequestCWProxy {
  ...
  ForgotPasswordRequest username(String? username);
  ...
  /// ````
  ForgotPasswordRequest call({String? email, String? username});
}
...
class _$ForgotPasswordRequestCWProxyImpl
  ...
  @override
  ForgotPasswordRequest username(String? username) => this(username: username);
